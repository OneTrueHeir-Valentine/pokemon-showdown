export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	zubat: {
		...
		abilities: {0: "Intimidate", 1: "Instinct", 2: "Infiltrator", H: "Stakeout"},
		heightm: 0.8,
		weightkg: 7.5,
		color: "Purple",
		evos: ["Golbat"],
	...
	celebi: {
		...
		abilities: {0: "Levitate", 1: "Misty Surge", 2: "Grassy Surge", H: "Psychic Surge"},
		heightm: 0.6,
		weightkg: 5,
		color: "Green",
		tags: ["Mythical"],
	...
	beldum: {
		...
		abilities: {0: "Clear Body", 1: "Levitate", 2: "Analytic", H: "Light Metal"},
		heightm: 0.6,
		weightkg: 95.2,
		color: "Blue",
		evos: ["Metang"],
