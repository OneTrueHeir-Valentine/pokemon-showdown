export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	articuno: {
		...
		abilities: {0: "Pressure", H: "Snow Warning", S: "Delta Stream"},
		heightm: 1.7,
		weightkg: 55.4,
		color: "Blue",
		tags: ["Sub-Legendary"],
	...
	zapdos: {
		...
		abilities: {0: "Pressure", H: "Drizzle", S: "Delta Stream"},
		heightm: 1.6,
		weightkg: 52.6,
		color: "Yellow",
		tags: ["Sub-Legendary"],
	...
	zapdosgalar: {
		...
		gender: "N",
		baseStats: {hp: 90, atk: 140, def: 90, spa: 85, spd: 90, spe: 110},
	...
	moltres: {
		...
		abilities: {0: "Pressure", H: "Drought", S: "Delta Stream"},
		heightm: 2,
		weightkg: 60,
		color: "Yellow",
		tags: ["Sub-Legendary"],
