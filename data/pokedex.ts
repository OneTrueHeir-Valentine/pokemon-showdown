export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	fearow: {
		...
		name: "Fearow",
		types: ["Flying"],
		baseStats: {hp: 120, atk: 110, def: 65, spa: 41, spd: 61, spe: 128},
		abilities: {0: "Keen Eye", 1: "Intimidate", H: "Sniper", S: "Reckless"},
		heightm: 1.2,
		weightkg: 38,
		color: "Brown",
	...
	pupitar: {
		...
		abilities: {0: "Shell Armor", 1: "Shed Skin", H: "Hustle"},
		heightm: 1.2,
		weightkg: 152,
		color: "Gray",
		prevo: "Larvitar",
	...
	milotic: {
		...
		name: "Milotic",
		types: ["Water", "Fairy"],
		baseStats: {hp: 114, atk: 80, def: 94, spa: 106, spd: 125, spe: 81},
		abilities: {0: "Marvel Scale", 1: "Serene Grace", H: "Multiscale"},
		heightm: 6.2,
		weightkg: 162,
		color: "Pink",
		prevo: "Feebas",
	...
	shelgon: {
		...
		abilities: {0: "Rough Skin", 0: "Shell Armor", H: "Overcoat"},
		heightm: 1.1,
		weightkg: 110.5,
		color: "White",
		prevo: "Bagon",
	...
	garchompmega: {
		...
		forme: "Mega",
		types: ["Dragon", "Ground"],
		baseStats: {hp: 108, atk: 170, def: 115, spa: 100, spd: 95, spe: 102},
