export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	rattata: {
		...
		abilities: {0: "Run Away", 1: "Guts", H: "Hustle", H: "Strong Jaw"},
		heightm: 0.3,
		weightkg: 3.5,
		color: "Purple",
		evos: ["Raticate"],
	...
	rattataalola: {
		...
		types: ["Dark", "Normal"],
		baseStats: {hp: 47, atk: 69, def: 42, spa: 40, spd: 42, spe: 100},
		abilities: {0: "Gluttony", 1: "Hustle", H: "Thick Fat", H: "Strong Jaw"},
		heightm: 0.3,
		weightkg: 3.8,
		color: "Black",
		evos: ["Raticate-Alola"],
	...
	gyaradosmega: {
		...
		forme: "Mega",
		types: ["Water", "Dragon"],
		baseStats: {hp: 114, atk: 160, def: 90, spa: 160, spd: 90, spe: 86},
	...
	milotic: {
		...
		abilities: {0: "Marvel Scale", 1: "Serene Grace", H: "Multiscale", H: "Kaiju"},
		heightm: 6.2,
		weightkg: 162,
		color: "Pink",
		prevo: "Feebas",
	...
	volcarona: {
		...
		name: "Volcarona",
		types: ["Bug", "Fire"],
		baseStats: {hp: 90, atk: 50, def: 75, spa: 135, spd: 125, spe: 100},
	...
	chesnaught: {
		...
		abilities: {0: "Overgrow", H: "Bulletproof", H: "Unburden"},
		heightm: 1.6,
		weightkg: 90,
		color: "Green",
		prevo: "Quilladin",
