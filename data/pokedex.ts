export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	grimer: {
		...
		abilities: {0: "Regenerator", 1: "Sticky Hold", H: "Merciless", S: "Gooey"},
		heightm: 0.9,
		weightkg: 30,
		color: "Purple",
		evos: ["Muk"],
	...
	omastar: {
		...
		types: ["Rock", "Water"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 100, atk: 125, def: 160, spa: 60, spd: 110, spe: 45},
		abilities: {0: "Strong Jaw", 1: "Battle Armor", H: "Weak Armor", S: "Storm Drain"},
		heightm: 1,
		weightkg: 35,
		color: "Blue",
	...
	aerodactyl: {
		...
		abilities: {0: "Rock Head", 1: "Pressure", H: "Unnerve", S: "Reckless"},
		heightm: 1.8,
		weightkg: 59,
		color: "Purple",
		eggGroups: ["Flying"],
	...
	jirachi: {
		...
		gender: "N",
		baseStats: {hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100},
		abilities: {0: "Serene Grace", 0: "Serene Grace", H: "Sturdy"},
		heightm: 0.3,
		weightkg: 1.1,
		color: "Yellow",
		tags: ["Mythical"],
	...
	roserade: {
		...
		name: "Roserade",
		types: ["Grass", "Poison"],
		baseStats: {hp: 60, atk: 60, def: 60, spa: 130, spd: 105, spe: 110},
		abilities: {0: "Serene Grace", 1: "Solar Power", H: "Technician"},
		heightm: 0.9,
		weightkg: 14.5,
		color: "Green",
